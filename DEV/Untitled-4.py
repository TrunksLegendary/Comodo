no=70   # Timeout 
Head_computer=r'VMDESKTOP-TEST1' # Head computer to send the email 
...
list_head=['Computer_Name', 'IP_Address',"Installed softwares","Software Versions"]
...
class LongFunctionInside(object):
    ...
    def long_function(self, timeout,no):
        ...
        folder=os.environ['SYSTEMDRIVE']+r'\ITSM-Reports'
