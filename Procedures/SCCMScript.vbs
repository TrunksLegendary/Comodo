...
'If UseCurrentDirectory = "yes" all shared folders paths will be overwritten with the path from where the script is run from
InstallCCC = "yes"
...
If (UseCurrentDirectory = "yes") Then
	SharedFolderCCC = sCurPath
	SharedFolderMST = sCurPath
	SharedFolderCCS = sCurPath
	SharedFolderPathCAV = sCurPath
End If
Dim fso    
