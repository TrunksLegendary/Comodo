...
def check_server(address, port, type, nr):
	try:
		...
		if nr == 2:
			...
			s.settimeout(10)
			request = bytearray.fromhex("ef070401002d201bab1c00197e02e5bc3c31cd48b5a9e77250e09e50345d003395856ce81f2b7382dee72602f798b642f14140")
			#print(request)
...
check_server ( "18.197.207.114", 3478, "UDP", 4 )
check_server ( "52.29.123.206", 3478, "UDP", 4 )
check_server ( "18.196.107.208", 3478, "UDP", 4 )
check_server ( "23.236.135.51", 3478, "UDP", 4 )
check_server ( "23.236.135.60", 3478, "UDP", 4 )